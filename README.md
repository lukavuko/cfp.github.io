...
<img src="assets/CFP-webpage-image.jpg" alt="" width="1000">
...
| Workspace | Note |
| --- | --- |
| 🌐 [**Project Pins**][pins]      | *Hosted with github.io* |
| [![][ico-zulip] **Zulip**][zulip] | *Primary communication channel* |
| [![][ico-gdrive] **Google Drive**][gdrive] | *Repository of shared documents* |
| [![][ico-zotero] **Zotero**][zotero] | *CFP specific research library* |
| [![][ico-trello] **Trello**][trello] | *Project management tool (open to alternatives)* |
| [![][ico-figma]  **Figma**][figma] | *UI/UX Design and Mockups* |
| [![][ico-dbdiagram] **dbdiagram.io**][dbdiagram] | *Data Model* |
| *Coming soon* | *Architecture* |
| *Coming soon* | *Code Repository* |

## Distinguished Resources

A non-exhaustive list of key contributions, documents, and resources available to the CFP.

| **Resource** | **Authorship** |
| --- | --- |
| [📊 Survey Results & Analysis][survey-analysis] | S. Guerrero |
| [🏠 Commons Fabric Project Site][cfp-site] | M. Peacock |
| [📋 Product Requirements Specification (v3)][prs] | R. Clarke |
| [📅 Calendar Ideation][calendar] | S. Wu |
| [💬 "Reddit but good"][reddit-good] | M. Boulerice |
| [🎓 Max's Thesis][thesis] | M. Peacock |
| [📝 Raw Survey Responses][survey-raw] | S. Guerrero |
| [🏘️ Rideau Community Hub][rideau-hub] | - |
| *More to come!* | ... |
...
<!-- Tool links -->
[pins]:      https://lukavuko.github.io/cfp.github.io
...
[cfp-site]:        https://commonsfabric.ca/?referrer=luma
[prs]:             https://docs.google.com/document/d/1XTXcCaKjmw1Kqcr2BH44gQjJPnHhVlwS/edit
[calendar]:        https://docs.google.com/document/d/145Tjj4XUg5hRhZTW2nca89PMVU-tb1shg3rAdfUHkHo/edit?tab=t.0#heading=h.vlv415tj7tsw
